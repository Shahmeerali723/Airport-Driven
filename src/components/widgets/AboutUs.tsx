  ...
  return (
    <section className="bg-custom-radial text-white py-16">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="relative flex flex-col md:flex-row items-center justify-center md:w-1/2 py-8 ">
          <div className="absolute mt-20   md:mr-12 rounded-lg overflow-hidden shadow-lg w-48 h-48 md:w-64 md:h-64">
            <Image
          ...
          <div className="relative top-0 left-0 z-10 ml-36 md:ml-48 md:mt-0 rounded-lg overflow-hidden shadow-lg w-48 h-48 md:w-64 md:h-64">
            <Image
