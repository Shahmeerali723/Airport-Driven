  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center font-plus-jakarta ">
      <div className="w-full flex flex-col gap-8">
        ...
        <div className={`mb-2 grid ${selectedStationType === "railway" ? "grid-cols-1" : "grid-cols-5"} gap-4`}>
          ...
          <div className={`${selectedStationType === "railway" ? "col-span-1" : "col-span-1"} grid ${selectedStationType === "railway" ? "grid-cols-5" : "grid-cols-1"} gap-4`}>
